...
%package staticdev
Summary: staticdev components for the libtheora package.
Group: Default
Requires: libtheora-dev = %{version}-%{release}

%description staticdev
staticdev components for the libtheora package.
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598781515
...
%define _lto_cflags 1
##
%autogen  --enable-shared --enable-static --enable-examples --enable-oggtest --enable-vorbistest --disable-maintainer-mode
